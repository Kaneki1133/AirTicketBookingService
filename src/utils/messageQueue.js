...
const publishMessage = async (channel, binding_key, message) => {
    try {
        ...
        //console.log("The Channel Looks like ", channel);
        //console.log("The queue looks like ", assert);
        //console.log("The Exchange Name is ", EXCHANGE_NAME);
        await channel.publish(EXCHANGE_NAME, binding_key, Buffer.from(message));
        //console.log("THE PUBLISH RESPONSE LOOKS LIKE ", response);
    } catch (error) {
        throw error;
    }
}
